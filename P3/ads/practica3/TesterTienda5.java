...
public class TesterTienda5 {
    public static void main(String[] args) {
        ...
        Electrodomestico teleCurva1 = new TelevisionCurva("Samsung", "4K UHD 2019 43RU7405", 399.00,
                ClaseEnergetica.A, 43, 9.5, new Dimension(115, 17, 67));

        Venta[] ventas = new Venta[7];
        ...
        ventas[6] = new VentaCanarias(teleCurva1);
        for (Venta v : ventas) {
