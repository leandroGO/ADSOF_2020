...
import rules.strategy.AsLongAsPossible;
...
public class Tester4 {
    public static void main(String[] args) {
        ...
        Node<Integer> n0 = new Node<>(0); // El valor del nodo es la longitud del camino. N0 es nodo inicial
        Node<Integer> n1 = new Node<>(INIT_CONSTANT); // inicializamos el resto a un valor alto, que iremos reduciendo
        Node<Integer> n2 = new Node<>(INIT_CONSTANT);
        Node<Integer> n3 = new Node<>(INIT_CONSTANT);
        ...
        try {
            ...
            g.connect(n1, 10, n3);
            g.connect(n2, 3, n3);
        } catch (NotInGraphException ex) {
            System.out.println(ex.toString());
            return;
        }
        System.out.println("Grafo inicial: \n"+g);
        // Estrategia de ejecución “as long as possible”
        RuleSetWithStrategy<Node<Integer>> rs = new RuleSetWithStrategy<>(new AsLongAsPossible<>());
